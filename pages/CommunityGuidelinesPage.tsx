...
const CommunityGuidelinesPage: React.FC = () => {
  ...
  const policy = policies.find(p => p.id === 'community-guidelines' && p.status === 'Active');
    ...
    <div className="max-w-4xl mx-auto bg-white p-8 rounded-lg shadow-md">
       {policy ? (
        ...
        <div className="text-center py-20">
            ...
            <h1 className="mt-6 text-3xl font-bold text-brand-dark">Community Guidelines Not Available</h1>
            <p className="mt-2 text-gray-500">The guidelines are currently being updated. Please check back later.</p>
        </div>
       )}
    </div>
  );
